...
# Page Layout
## Divide page into 3 columns (col1=sidebar; col2 & col3=page content)

col1 = st.sidebar
col2, col3 = st.beta_columns((2,1)) # the numbers indicate how to divide the space. In this case 2:1 ratio
...
# Preparing data for Bar plt of % Price Change
